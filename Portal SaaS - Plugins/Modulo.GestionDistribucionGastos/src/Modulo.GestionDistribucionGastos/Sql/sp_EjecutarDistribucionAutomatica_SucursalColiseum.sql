-- Extiende la cascada Sucursal->Canal->Centro de costo a la nueva base
-- 'SUCURSAL_COLISEUM' (ver Sql/vw_VentaBaseDistribucion_SucursalColiseum.sql) -- misma
-- lógica de reparto por sucursal que 'SUCURSAL'/'SUCURSAL_TPR_ECM'/'SUCURSAL_TPR_SOLO_ECOM'.
-- Único cambio respecto a la versión anterior
-- (Sql/sp_EjecutarDistribucionAutomatica_VentaSucursalMarcas.sql): las 5 apariciones de
-- "v.TipoBase IN ('SUCURSAL', 'SUCURSAL_TPR_ECM', 'SUCURSAL_TPR_SOLO_ECOM', 'VENTA_SUCURSAL_CONVERSE',
-- 'VENTA_SUCURSAL_UMBRO', 'VENTA_SUCURSAL_FILA', 'VENTA_SUCURSAL_SM')" pasan a incluir también
-- 'SUCURSAL_COLISEUM'.
    ...
    BEGIN TRY
        ...
        LineasDistribuidas AS (
            SELECT
                ...
                d.MontoOriginal,
                CASE WHEN v.TipoBase IN ('SUCURSAL', 'SUCURSAL_TPR_ECM', 'SUCURSAL_TPR_SOLO_ECOM', 'SUCURSAL_COLISEUM',
                ...
                CASE
                    ...
                    WHEN v.TipoBase IN ('SUCURSAL', 'SUCURSAL_TPR_ECM', 'SUCURSAL_TPR_SOLO_ECOM', 'SUCURSAL_COLISEUM',
                                         'VENTA_SUCURSAL_CONVERSE', 'VENTA_SUCURSAL_UMBRO', 'VENTA_SUCURSAL_FILA', 'VENTA_SUCURSAL_SM')
            ...
            LEFT JOIN dbo.Maestro_Sucursal msuc
                ...
                AND v.TipoBase IN ('SUCURSAL', 'SUCURSAL_TPR_ECM', 'SUCURSAL_TPR_SOLO_ECOM', 'SUCURSAL_COLISEUM',
                                    'VENTA_SUCURSAL_CONVERSE', 'VENTA_SUCURSAL_UMBRO', 'VENTA_SUCURSAL_FILA', 'VENTA_SUCURSAL_SM')
        )
