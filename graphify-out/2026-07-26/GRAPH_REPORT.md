...
## Corpus Check
- 1155 files · ~393,990 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2101 nodes · 3423 edges · 238 communities (132 shown, 106 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3194eeaa`
...
- SalesDocumentType
- PurchaseDocumentDto.cs
- PurchaseDocumentType
- User
- CreateModel
- EditModel
- .BuildWhereClause
- SalesDocumentTypeCatalog.cs
- IndexModel
- SapPurchaseDocumentHeader
- SapInventoryDocumentHeader
...
1. `PortalSaas.Abstractions.Modelos` - 103 edges
2. `PortalSaas.Abstractions.Contratos` - 90 edges
3. `PortalSaasDbContext` - 61 edges
4. `PortalSaas.Data.Entities` - 47 edges
5. `PortalSaas.Data` - 40 edges
6. `SalesDocumentType` - 26 edges
7. `Modelo Core — Capa Comercial` - 24 edges
8. `PortalSaas.Data.Entities` - 23 edges
9. `DetailGenericSalesDocumentModelBase` - 20 edges
10. `TenantUserAdminService` - 20 edges
...
- `DetailGenericPurchaseDocumentModelBase` --references--> `IPurchaseDocumentService`  [EXTRACTED]
  plugins/Modulo.Compras/Pages/DetailGenericPurchaseDocumentModelBase.cs → src/PortalSaas.Abstractions/Contratos/IPurchaseDocumentService.cs
- `DetailGenericPurchaseDocumentModelBase` --references--> `ISupplierCatalogService`  [EXTRACTED]
  plugins/Modulo.Compras/Pages/DetailGenericPurchaseDocumentModelBase.cs → src/PortalSaas.Abstractions/Contratos/ISupplierCatalogService.cs
...
## Communities (238 total, 106 thin omitted)

### Community 0 - "Núcleo Auth/Datos/Admin (mixto)"
Cohesion: 0.09
Nodes (14): PortalSaas.Data.Entities, PortalSaas.Host.Pages.Admin.Organizations.Licenses, PortalSaas.Core.Comercial, PortalSaas.Core.Tests, PortalSaas.Data, PortalSaas.Host.Pages.Admin.Organizations.Subscriptions, PortalSaas.Core.Usuarios, PortalSaas.Host.Comandos (+6 more)
...
Cohesion: 0.10
Nodes (22): CancellationToken, Guid, Task, IUserPreferenceService, UserPreferenceDto, CancellationToken, Guid, Task (+14 more)
...
Cohesion: 0.29
Nodes (5): IPasswordResetService, IActionResult, InputModel, Task, ResetPasswordModel
...
Cohesion: 0.12
Nodes (15): PortalSaas.Host.Pages.Admin.MenuGroups, Menu, IActionResult, InputModel, PortalSaasDbContext, Task, CreateModel, InputModel (+7 more)

### Community 10 - "Login de Administrador de Plataforma"
Cohesion: 0.05
Nodes (40): Admin, PortalSaas.Host.Pages.Admin, CancellationToken, Guid, Task, IAuthenticationService, CancellationToken, Task (+32 more)
...
Cohesion: 0.08
Nodes (22): AuditLog, Company, PortalSaas.Data.Migrations.SqlServer, DbContext, DbSet, EmailSettings, Instance, MenuGroupItem (+14 more)
...
Cohesion: 0.40
Nodes (3): PortalSaas.Data.Migrations.PostgreSql, IDesignTimeDbContextFactory, DesignTimeDbContextFactory
...
Cohesion: 0.18
Nodes (14): PortalSaas.Host.Pages.Admin.Organizations.EmailSettings, Guid, IActionResult, InputModel, ISecretoCifradoService, MenuGroup, Organization, GoogleWorkspaceConfigInput (+6 more)
...
Cohesion: 0.15
Nodes (8): PortalSaas.Host.Pages, PortalSaas.Host.Pages.Home, PageModel, ILogger, ErrorModel, IndexModel, IActionResult, IndexModel
...
Cohesion: 0.07
Nodes (18): Modulo.Administracion, IEnumerable, IModuloPortal, IServiceCollection, MenuItemDefinition, ModuloAdministracion, IEnumerable, IServiceCollection (+10 more)
...
Cohesion: 0.10
Nodes (24): CancellationToken, PortalSaas.Core.Administracion, Db, Fact, ICollection, LimitCheckResult, Org, Plan (+16 more)
...
Cohesion: 0.05
Nodes (49): DetailGenericInventoryDocumentModelBase, IndexGenericInventoryDocumentModelBase, CancellationToken, DateOnly, DocumentFormViewModel, IActionResult, ICurrentUserContext, IItemCatalogService (+41 more)
...
Cohesion: 0.07
Nodes (24): HanaCommand, Regex, SqlCommand, CancellationToken, IReadOnlyList, Task, IHanaService, CancellationToken (+16 more)

### Community 44 - "Página Crear Organización (code-behind)"
Cohesion: 0.21
Nodes (9): PortalSaas.Host.Pages.Admin.Profiles, PermissionAction, IActionResult, InputModel, List, PortalSaasDbContext, Task, EditModel (+1 more)
...
Cohesion: 0.18
Nodes (8): PortalSaas.Host.Pages.Admin.Plans, IActionResult, InputModel, PortalSaasDbContext, Task, CreateModel, InputModel, InputModel
...
Cohesion: 0.15
Nodes (8): PortalSaas.Host.Pages.Account, InputModel, IActionResult, Task, LogoutModel, InputModel, Guid, InputModel
...
Cohesion: 0.16
Nodes (14): ICustomerCatalogService, ISalesEmployeeCatalogService, CancellationToken, DocumentFormViewModel, IActionResult, ICurrentUserContext, IItemCatalogService, InputModel (+6 more)

### Community 64 - "Proyecto Abstractions (csproj)"
Cohesion: 0.12
Nodes (21): Error, CancellationToken, Guid, Task, ISapConnectionTestService, SapConnectionTestResult, CancellationToken, Company (+13 more)
...
Cohesion: 0.07
Nodes (14): PortalSaas.Abstractions.Contratos, Modulo.Ventas, Modulo.Ventas.Pages.SalesOrders, Modulo.Compras.Pages.PurchaseQuotations, Modulo.Compras.Pages.PurchaseOrders, Modulo.Inventario, PortalSaas.Abstractions.Modelos, Modulo.Inventario.Pages.StockTransfers (+6 more)
...
Cohesion: 0.09
Nodes (11): PortalSaas.Host.Pages.Admin.Organizations.Users, PortalSaas.Core.Infraestructura, PortalSaas.Host.Pages.Admin.Organizations.Companies, PortalSaas.Core.Sap, Microsoft.AspNetCore.Mvc.Rendering, PortalSaas.Data.Entities, PortalSaas.Host.Pages.Home.PreferencesModel, InputModel (+3 more)
...
Cohesion: 0.16
Nodes (10): HashSet, long, List, MenuNodeDto, CancellationToken, IReadOnlyList, List, Task (+2 more)
...
Cohesion: 0.13
Nodes (15): CancellationToken, DocumentListViewModel, FilterInput, IActionResult, ICurrentUserContext, Task, IndexGenericSalesDocumentModelBase, CancellationToken (+7 more)
...
Cohesion: 0.09
Nodes (13): Modulo.Ventas.Pages.ReserveInvoices, Modulo.Ventas.Pages.Receipts, Modulo.Ventas.Pages.Returns, Modulo.Ventas.Pages.ReturnRequests, Modulo.Ventas.Pages.CustomerInvoices, IndexGenericSalesDocumentModelBase, IndexModel, IndexModel (+5 more)
...
Cohesion: 0.19
Nodes (12): CancellationToken, DocumentFormViewModel, IActionResult, ICurrentUserContext, IItemCatalogService, InputModel, IWarehouseCatalogService, JsonResult (+4 more)

### Community 136 - "AdminPageModelBase"
Cohesion: 0.18
Nodes (8): Modulo.Administracion.Pages, Exception, ICurrentCompanyAccessor, ICurrentUserContext, PageHandlerExecutingContext, AdminPageModelBase, PortalSaasDbContext, MenuNavigationService

### Community 137 - "Create.cshtml.cs"
Cohesion: 0.20
Nodes (11): CancellationToken, IReadOnlyList, Task, ISupplierCatalogService, SupplierDto, SupplierFilter, CancellationToken, IHanaService (+3 more)
...
Cohesion: 0.18
Nodes (11): CancellationToken, DocumentListViewModel, FilterInput, IActionResult, ICurrentUserContext, Task, IndexGenericPurchaseDocumentModelBase, CancellationToken (+3 more)

### Community 145 - "PortalSaas.sln"
Cohesion: 0.15
Nodes (8): Modulo.Administracion, Modulo.Ventas, PortalSaas.Core, PortalSaas.Data.Migrations.PostgreSql, PortalSaas.Data.Migrations.SqlServer, PortalSaas.Host, PortalSaas.Core.Tests, PortalSaas.Tools.EmailSmokeTest
...
Cohesion: 0.21
Nodes (7): PortalSaas.Host.ViewComponents, PortalSaas.Abstractions.Componentes, DocumentFormViewModel, IViewComponentResult, DocumentFormViewComponent, DocumentListViewComponent, ViewComponent
...
Cohesion: 0.31
Nodes (7): Entry, SalesDocumentDto, CancellationToken, IHanaService, ISapConnectionProvider, Task, SalesDocumentService

### Community 157 - "IndexModel"
Cohesion: 0.33
Nodes (5): Guid, IActionResult, List, Task, IndexModel

### Community 158 - "PortalSaas.Abstractions.csproj"
Cohesion: 0.22
Nodes (6): net8.0, net8.0, Microsoft.NET.Sdk.Razor, net8.0, Microsoft.NET.Sdk.Razor, Microsoft.NET.Sdk.Razor

### Community 161 - "DocumentFormViewModel"
Cohesion: 0.28
Nodes (8): PurchaseDocumentDto, CancellationToken, IHanaService, ISapConnectionProvider, Task, PurchaseDocumentService, IReadOnlyDictionary, PurchaseDocumentTypeCatalog
...
Cohesion: 0.18
Nodes (5): PortalSaas.Core.Compras, PortalSaas.Core.Ventas, PortalSaas.Core.Inventario, Entry, Entry

### Community 165 - "Default.cshtml"
Cohesion: 0.11
Nodes (14): Modulo.Inventario.Pages, Modulo.Ventas.Pages, Modulo.Compras.Pages, LineInput, DateOnly, FilterInput, LineInput, DateOnly (+6 more)

### Community 171 - "SalesDocumentType"
Cohesion: 0.33
...
### Community 172 - "PurchaseDocumentDto.cs"
Cohesion: 0.22
Nodes (7): DateTime, PurchaseDocumentFilter, PurchaseDocumentLineDto, PurchaseDocumentSummaryDto, IReadOnlyDictionary, Parameters, WhereClause

### Community 173 - "PurchaseDocumentType"
Cohesion: 0.32
Nodes (7): DetailGenericPurchaseDocumentModelBase, IndexGenericPurchaseDocumentModelBase, DetailModel, IndexModel, DetailModel, IndexModel, PurchaseDocumentType

### Community 174 - "User"
Cohesion: 0.25
Nodes (6): DateTimeOffset, Guid, PasswordResetToken, DateTimeOffset, Guid, User

### Community 175 - "CreateModel"
Cohesion: 0.25
Nodes (6): IActionResult, InputModel, PortalSaasDbContext, Task, CreateModel, InputModel

### Community 176 - "EditModel"
Cohesion: 0.38
Nodes (5): IActionResult, InputModel, PortalSaasDbContext, Task, EditModel

### Community 177 - ".BuildWhereClause"
Cohesion: 0.33
Nodes (5): ExtraFilter, IReadOnlyDictionary, IReadOnlyList, Parameters, WhereClause

### Community 178 - "SalesDocumentTypeCatalog.cs"
Cohesion: 0.33
Nodes (5): IReadOnlyDictionary, IReadOnlyList, Entry, ExtraFilter, SalesDocumentTypeCatalog

### Community 179 - "IndexModel"
Cohesion: 0.33
Nodes (5): Guid, IActionResult, List, Task, IndexModel

### Community 180 - "SapPurchaseDocumentHeader"
Cohesion: 0.50
Nodes (4): DateTime, List, SapPurchaseDocumentHeader, SapPurchaseDocumentLine

### Community 181 - "SapInventoryDocumentHeader"
Cohesion: 0.50
Nodes (4): DateTime, List, SapInventoryDocumentHeader, SapInventoryDocumentLine

### Community 182 - "SapSalesDocumentHeader"
Cohesion: 0.50
Nodes (4): DateTime, List, SapSalesDocumentHeader, SapSalesDocumentLine

### Community 183 - "HttpClientFactoryStub"
Cohesion: 0.50
Nodes (3): IHttpClientFactory, HttpClient, HttpClientFactoryStub

### Community 184 - "InputModel"
Cohesion: 0.50
Nodes (4): DateOnly, LineInput, List, InputModel

### Community 185 - "InputModel"
Cohesion: 0.50
Nodes (4): DateOnly, LineInput, List, InputModel

## Knowledge Gaps
- **240 isolated node(s):** `Qué es esto`, `Decisiones ya tomadas (no reabrir sin una razón nueva y explícita)`, `Reglas que no se negocian`, `Dónde está cada cosa`, `Estructura de código real (24 jul 2026)` (+235 more)
...
- **Why does `PortalSaas.Abstractions.Modelos` connect `PortalSaas.Abstractions.Contratos` to `Núcleo Auth/Datos/Admin (mixto)`, `ProviderConfigDeserializationTests`, `Límites de Contrato (IContractLimitService)`, `Envío de Correo — Gmail/MIME`, `Preferencias de Usuario`, `PortalSaas.Core.Tests.csproj`, `Create.cshtml.cs`, `Login de Administrador de Plataforma`, `.SearchAsync`, `.ListAsync`, `.ListAsync`, `Páginas Home/Logout (Host)`, `PortalActions`, `PlatformAdmin`, `Herramienta EmailSmokeTest`, `Default.cshtml`, `Página Crear Usuario (code-behind)`, `SalesDocumentType`, `PurchaseDocumentDto.cs`, `PurchaseDocumentType`, `SalesDocumentTypeCatalog.cs`, `Proyecto Abstractions (csproj)`, `PortalSaas.Data.Entities`, `PluginLoadContext`, `SapEngineType.cs`, `IndexModel`?**
  _High betweenness centrality (0.185) - this node is a cross-community bridge._
- **Why does `PortalSaas.Abstractions.Contratos` connect `PortalSaas.Abstractions.Contratos` to `Núcleo Auth/Datos/Admin (mixto)`, `ProviderConfigDeserializationTests`, `Entidad PlatformAdmin`, `PlatformAdmin`, `Cifrado de Secretos (AES-256-GCM)`, `Default.cshtml`, `Entidad Plan / Página Índice de Planes`, `Login de Administrador de Plataforma`, `Proyecto Host (csproj)`, `PortalSaas.Data.Entities`, `Autenticación / Acceso por Organización`, `PortalSaas.Host.ViewComponents`, `Estructura de la Solución (.sln)`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **Why does `PortalSaas.Data` connect `Núcleo Auth/Datos/Admin (mixto)` to `Migración InitialCreate — Designer (PostgreSQL)`, `Migración AddEmailSettings — Designer`, `Migración AddPlatformAdmins — Designer`, `Migración FixCompanyOrganizationCascade — Designer`, `20260725001330_AddPlanToOnPremiseLicense.Designer.cs`, `PortalSaas.Abstractions.Contratos`, `Tests de Autenticación de Admin`, `PortalSaas.Data.Entities`, `Snapshot del Modelo EF (Migraciones)`, `Factory de DbContext en Tiempo de Diseño`, `Migraciones EF — Designer (PostgreSQL)`?**
