...
<#
    ...
    Uso:
      .\NX_DEP_TransferenciaAutomatica_v2-SetClaveMaestra.ps1 -ClaveMaestra "<clave-base64-de-32-bytes-de-ESTE-proyecto>"
      .\NX_DEP_TransferenciaAutomatica_v2-SetClaveMaestra.ps1 -ClaveMaestra "..." -NoReiniciar
#>
param(
...
if (-not (Test-Path $registryPath)) {
    throw "No existe el servicio '$ServiceName' en el registro. Instalalo primero con NX_DEP_TransferenciaAutomatica_v2-Install.ps1."
}
