...
Cohesion: 0.11
Nodes (10): PortalSaas.Core.Tests.ImportacionGenerica, Modulo.ImportacionGenerica.Pages.Configuracion, PortalSaas.Core.ImportacionGenerica, FieldInput, UserFieldMappingInput, ValidationRuleInput, GenericImportLogicalField, GenericImportValidationSeverity (+2 more)
...
Cohesion: 0.33
Nodes (4): Dictionary, HashSet, string, SapAdditionalFieldsHelper
...
Cohesion: 0.12
Nodes (15): Alcance, Archivos tocados (estimado, a confirmar en el plan de implementación), Cambios de contrato/catálogo nuevos, Catálogo de tipos de regla, Configuración por Formato (`Pages/Configuracion/Index.cshtml`), Decisiones descartadas (y por qué), Modelo de datos, Motor de reglas (+7 more)
...
Cohesion: 0.10
Nodes (16): DocumentFormViewModel, IReadOnlyList, DocumentListColumn, DocumentListFilter, DocumentListFilterOption, DocumentListRow, DocumentListViewModel, FilterFieldType (+8 more)

### Community 134 - "ImportacionGenerica Plugin - PageModelBaseAdmin.cs"
Cohesion: 0.17
Nodes (11): Guid, ICurrentCompanyAccessor, string, ISapTraceabilityFieldResolver, SapTraceabilityFieldResolver, Guid, CompanyAccessorFijo, Guid (+3 more)
...
Cohesion: 0.20
Nodes (9): Alcance, Archivos tocados, Componente nuevo: `GenerateResultReportAsync`, Estado por grupo, Flujo de datos, Problema, Reporte Excel de resultado de la importación genérica, Tests (+1 more)
...
Cohesion: 0.58
Nodes (3): Fact, Task, CurrentUserContextTests

### Community 174 - "Data.Migrations.PostgreSql - Migrations"
Cohesion: 0.18
Nodes (7): Guid, ICurrentCompanyOverride, Guid, IHttpContextAccessor, CurrentCompanyAccessor, Guid, CurrentCompanyOverride
...
### Community 194 - "Data.Migrations.PostgreSql - Migrations"
Cohesion: 0.28
...
### Community 219 - "ImportacionGenerica Plugin - Configuracion"
Cohesion: 0.50
Nodes (3): Modulo.ImportacionGenerica.Pages.Configuracion.IndexModel, PortalSaas.Abstractions.Modelos, route:/importacion-generica/configuracion
...
Cohesion: 0.48
Nodes (5): IEqualityComparer, ItemCode, TupleComparer, TupleComparer, Warehouse
...
Cohesion: 0.15
Nodes (11): CancellationToken, Guid, Task, IIntegrationConnectorConfigService, CancellationToken, Guid, Task, IntegrationConnectorConfigService (+3 more)
...
Cohesion: 0.33
Nodes (4): CancellationToken, IReadOnlyList, Task, ICustomerShipToAddressService
