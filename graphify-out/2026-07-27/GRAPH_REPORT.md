# Graph Report - Proyecto Saas Portal  (2026-07-26)

## Corpus Check
- 1156 files · ~399,682 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2154 nodes · 3429 edges · 242 communities (134 shown, 108 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a400082d`
...
- `IndexModel` --references--> `InventoryDocumentType`  [EXTRACTED]
  plugins/Modulo.Inventario/Pages/InventoryTransferRequests/Index.cshtml.cs → src/PortalSaas.Abstractions/Modelos/InventoryDocumentType.cs
- `IndexModel` --references--> `InventoryDocumentType`  [EXTRACTED]
  plugins/Modulo.Inventario/Pages/StockTransfers/Index.cshtml.cs → src/PortalSaas.Abstractions/Modelos/InventoryDocumentType.cs
...
## Communities (242 total, 108 thin omitted)

### Community 0 - "Núcleo Auth/Datos/Admin (mixto)"
Cohesion: 0.09
Nodes (12): PortalSaas.Data.Entities, PortalSaas.Core.Comercial, PortalSaas.Core.Tests, PortalSaas.Data, PortalSaas.Host.Pages.Admin.Organizations.Subscriptions, PortalSaas.Core.Usuarios, PortalSaas.Host.Comandos, PortalSaas.Core.Seguridad (+4 more)
...
Cohesion: 0.24
Nodes (10): CancellationToken, Guid, Task, PasswordResetService, Db, Fact, Org, Task (+2 more)
...
Cohesion: 0.07
Nodes (25): AuditLog, Company, PortalSaas.Data.Migrations.PostgreSql, PortalSaas.Data.Migrations.SqlServer, DbContext, DbSet, EmailSettings, IDesignTimeDbContextFactory (+17 more)
...
Cohesion: 0.13
Nodes (18): CancellationToken, DateOnly, DocumentFormViewModel, IActionResult, ICurrentUserContext, IInventoryDocumentService, IItemCatalogService, InputModel (+10 more)

### Community 21 - "Entidad Subscription"
Cohesion: 0.28
Nodes (10): Guid, IActionResult, InputModel, ISecretoCifradoService, MenuGroup, Organization, IndexModel, PermissionsModel (+2 more)
...
Cohesion: 0.13
Nodes (13): IReadOnlyCollection, DateTimeOffset, Guid, Organization, OnPremiseLicense, OnPremiseLicenseStatus, Guid, IActionResult (+5 more)
...
Cohesion: 0.10
Nodes (23): CancellationToken, Db, Fact, ICollection, LimitCheckResult, Org, Plan, Guid (+15 more)
...
Cohesion: 0.07
Nodes (30): PortalSaas.Core.Inventario, DetailGenericInventoryDocumentModelBase, IHanaService, IInventoryDocumentService, ISapConnectionProvider, Parameters, DetailModel, DetailModel (+22 more)
...
Cohesion: 0.10
Nodes (12): PortalSaas.Host.Pages.Account, PortalSaas.Host.Pages.Admin.Organizations.Licenses, PortalSaas.Host.Pages.Admin.Organizations.Companies, Microsoft.AspNetCore.Mvc.Rendering, InputModel, InputModel, Guid, InputModel (+4 more)
...
Cohesion: 0.11
Nodes (20): ICustomerCatalogService, ISalesEmployeeCatalogService, CancellationToken, DateOnly, DocumentFormViewModel, IActionResult, ICurrentUserContext, IItemCatalogService (+12 more)
...
Cohesion: 0.07
Nodes (16): PortalSaas.Abstractions.Contratos, Modulo.Ventas, Modulo.Compras.Pages.PurchaseQuotations, Modulo.Compras.Pages.PurchaseOrders, Modulo.Inventario, Modulo.Ventas.Pages.ReturnRequests, PortalSaas.Abstractions.Modelos, Modulo.Inventario.Pages.StockTransfers (+8 more)
...
Cohesion: 0.11
Nodes (7): PortalSaas.Host.Pages.Admin.Organizations.Users, PortalSaas.Core.Administracion, PortalSaas.Core.Infraestructura, PortalSaas.Core.Sap, PortalSaas.Data.Entities, PortalSaas.Host.Pages.Home.PreferencesModel, InputModel
...
Cohesion: 0.20
Nodes (9): CancellationToken, DocumentListViewModel, FilterInput, IActionResult, ICurrentUserContext, ISalesDocumentService, SalesDocumentType, Task (+1 more)
...
Cohesion: 0.09
Nodes (12): Modulo.Ventas.Pages.ReserveInvoices, Modulo.Ventas.Pages.Receipts, Modulo.Ventas.Pages.Returns, Modulo.Ventas.Pages.CustomerInvoices, Modulo.Ventas.Pages.CreditNotes, IndexGenericSalesDocumentModelBase, IndexModel, IndexModel (+4 more)
...
Cohesion: 0.12
Nodes (19): ISupplierCatalogService, CancellationToken, DateOnly, DocumentFormViewModel, IActionResult, ICurrentUserContext, IItemCatalogService, InputModel (+11 more)
...
Cohesion: 0.20
Nodes (9): CancellationToken, DocumentListViewModel, FilterInput, IActionResult, ICurrentUserContext, IPurchaseDocumentService, PurchaseDocumentType, Task (+1 more)
...
Cohesion: 0.07
Nodes (37): Modulo.Ventas.Pages.SalesOrders, DetailGenericSalesDocumentModelBase, Entry, ExtraFilter, DetailModel, DetailModel, DetailModel, DetailModel (+29 more)
...
Cohesion: 0.10
Nodes (26): DetailGenericPurchaseDocumentModelBase, IndexGenericPurchaseDocumentModelBase, DetailModel, IndexModel, DetailModel, IndexModel, CancellationToken, Task (+18 more)
...
Cohesion: 0.20
Nodes (5): PortalSaas.Core.Compras, PortalSaas.Core.Ventas, Entry, Entry, ExtraFilter
...
### Community 174 - "User"
Cohesion: 0.20
Nodes (9): CancellationToken, DocumentListViewModel, FilterInput, IActionResult, ICurrentUserContext, IInventoryDocumentService, InventoryDocumentType, Task (+1 more)
...
### Community 212 - "Parameters"
Cohesion: 0.50
Nodes (3): DateTimeOffset, Guid, PlatformAdmin

## Knowledge Gaps
- **270 isolated node(s):** `Qué es esto`, `Decisiones ya tomadas (no reabrir sin una razón nueva y explícita)`, `Reglas que no se negocian`, `Dónde está cada cosa`, `Estructura de código real (24 jul 2026)` (+265 more)
...
- **Why does `PortalSaas.Abstractions.Modelos` connect `PortalSaas.Abstractions.Contratos` to `Núcleo Auth/Datos/Admin (mixto)`, `ProviderConfigDeserializationTests`, `Límites de Contrato (IContractLimitService)`, `Preferencias de Usuario`, `PortalSaas.Core.Tests.csproj`, `Create.cshtml.cs`, `Login de Administrador de Plataforma`, `.SearchAsync`, `.ListAsync`, `.ListAsync`, `Páginas Home/Logout (Host)`, `CreateModel`, `DocumentFormViewModel`, `PortalActions`, `PlatformAdmin`, `Herramienta EmailSmokeTest`, `Default.cshtml`, `Página Crear Usuario (code-behind)`, `CreateModel`, `EditModel`, `SalesDocumentTypeCatalog.cs`, `Estructura de la Solución (.sln)`, `Proyecto Abstractions (csproj)`, `PortalSaas.Data.Entities`, `PluginLoadContext`, `SapEngineType.cs`?**
  _High betweenness centrality (0.242) - this node is a cross-community bridge._
- **Why does `PortalSaas.Abstractions.Contratos` connect `PortalSaas.Abstractions.Contratos` to `Núcleo Auth/Datos/Admin (mixto)`, `ProviderConfigDeserializationTests`, `Entidad PlatformAdmin`, `PlatformAdmin`, `Cifrado de Secretos (AES-256-GCM)`, `Proyecto Host (csproj)`, `PortalSaas.Data.Entities`, `.BuildWhereClause`, `Autenticación / Acceso por Organización`, `PortalSaas.Host.ViewComponents`, `CreateModel`, `Estructura de la Solución (.sln)`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `PortalSaasDbContext` connect `Tests de Autenticación de Admin` to `Núcleo Auth/Datos/Admin (mixto)`, `Límites de Contrato (IContractLimitService)`, `Preferencias de Usuario`, `Hash de Contraseñas (PBKDF2)`, `Cifrado de Secretos (AES-256-GCM)`, `Resultado de Autenticación`, `Login de Administrador de Plataforma`, `Entidad Subscription`, `jQuery Validation Unobtrusive (JS)`, `IndexModel`, `CLAUDE.md — Estructura y Licencias de Terceros`, `Entidad Plan / Página Índice de Planes`, `Página Crear Licencia (code-behind)`, `jQuery Validation Unobtrusive (minificado)`, `SalesDocumentType`, `Página Crear Organización (code-behind)`, `PurchaseDocumentType`, `Página Editar Licencia (code-behind)`, `Página Editar Suscripción (code-behind)`, `Entidad Profile`, `Entidad MenuGroup`, `Página Crear Plan (code-behind)`, `Página Índice de Organizaciones (code-behind)`?**
